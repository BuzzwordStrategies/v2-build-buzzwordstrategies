...
const ContractAgreementForm = ({ 
      ...
      <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-[60] p-4">
        <div className="bg-[#121212] rounded-xl p-6 w-full max-w-3xl max-h-[85vh] overflow-y-auto border border-[#D28C00]/20">
          ...
          <div className="space-y-4 text-white/85 text-sm">
            ...
            <section>
              <h3 className="text-lg font-semibold text-[#D28C00] mb-2">3. How We Use Your Information</h3>
            ...
            <section>
              <h3 className="text-lg font-semibold text-[#D28C00] mb-2">9. Contact Us</h3>
              <p>
  ...
  const SubscriptionTerms = () => (
    <div className="bg-[#2A2A2A] border border-[#D28C00]/20 rounded-lg p-4 mb-4 text-sm text-white/85">
      <h4 className="font-medium text-[#D28C00] mb-2">Subscription Terms Summary</h4>
      <div className="space-y-2">
        <p>
          <strong>Initial Commitment:</strong> {subLength} months at ${finalMonthly}/month.
        </p>
        <p>
          <strong>Automatic Renewal:</strong> Monthly renewal after initial period until canceled.
        </p>
        <p>
          <strong>Early Termination:</strong> 50% of remaining payments if canceled during initial period.
        </p>
        <p>
          <strong>Billing Cycle:</strong> Payment charged on the same date each month.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-2xl font-bold text-white mb-4">Marketing Services Agreement</h2>
      <p className="text-sm text-white/85 mb-4">Please review and agree to the following terms.</p>
      
      {/* Subscription Terms Summary */}
      <SubscriptionTerms />
      
      {/* Contract text in scrollable container */}
      <div className="bg-[#2A2A2A] border border-[#D28C00]/20 rounded-lg p-4 h-[400px] overflow-y-auto mb-4 text-sm text-white/90">
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-[#D28C00]">MARKETING SERVICES AGREEMENT</h3>
          ...
          <h4 className="text-[#D28C00] mt-2">1. SERVICES</h4>
          ...
          <h4 className="text-[#D28C00] mt-2">2. TERM AND TERMINATION</h4>
          ...
          <h4 className="text-[#D28C00] mt-2">3. FEES AND PAYMENT</h4>
          ...
          <h4 className="text-[#D28C00] mt-2">4. INTELLECTUAL PROPERTY RIGHTS</h4>
          ...
          <h4 className="text-[#D28C00] mt-2">5. CONFIDENTIALITY</h4>
          ...
          <h4 className="text-[#D28C00] mt-2">6. REPRESENTATIONS AND WARRANTIES</h4>
          ...
          <h4 className="text-[#D28C00] mt-2">7. LIMITATION OF LIABILITY</h4>
          ...
          <h4 className="text-[#D28C00] mt-2">8. INDEMNIFICATION</h4>
          ...
          <h4 className="text-[#D28C00] mt-2">9. CLIENT RESPONSIBILITIES</h4>
          ...
          <h4 className="text-[#D28C00] mt-2">10. DATA PRIVACY AND COMPLIANCE</h4>
          ...
          <h4 className="text-[#D28C00] mt-2">11. GENERAL PROVISIONS</h4>
      ...
      <div className="space-y-3">
        <div className="flex items-start gap-2">
          ...
          />
          <label htmlFor="agreeToTerms" className="text-sm text-white/85">
        ...
        <div className="flex items-start gap-2 mt-3">
          <input
            ...
            className="mt-1 w-4 h-4 text-[#D28C00] bg-[#2A2A2A] border-[#D28C00]/20 rounded focus:ring-[#D28C00]/50"
          />
          <label htmlFor="privacyPolicyConsent" className="text-sm text-white/85">
            I have read and agree to the{' '}
            <button 
              type="button" 
              onClick={() => setShowPrivacyPolicy(true)}
              className="text-[#D28C00] underline"
            >
              Privacy Policy
            </button>
          </label>
        ...
        <div className="mt-4">
          ...
          <input
            ...
            className={`w-full p-3 bg-[#2A2A2A] border ${
              errors.signatureName ? 'border-red-500' : 'border-[#D28C00]/20'
            } rounded-lg text-white placeholder-white/40 focus:border-[#D28C00]/50 focus:outline-none transition-colors`}
          />
      ...
      <div className="grid grid-cols-2 gap-4 mt-8">
        ...
        <button
          ...
          className={`py-3 ${isProcessing ? 'bg-[#2A2A2A] text-white/50' : 'bg-[#D28C00] text-[#1A1A1A] hover:bg-[#B77A00]'} font-semibold rounded-lg transition-colors`}
          disabled={isProcessing}
        >
          {isProcessing ? (
