...
exports.handler = async (event) => {
  ...
  try {
    const { bundleID, stripeSessionID } = JSON.parse(event.body);
    ...
    await updateSupabase(bundleID, stripeSessionID);
...
async function updateSupabase(bundleID, stripeSessionID) {
